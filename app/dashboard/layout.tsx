...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#080808] text-white">
      {/* CSS Animation for tour pulse */}
      <style>{`
        @keyframes tourPulse {
          0%, 100% { 
            box-shadow: 0 0 0 3px rgba(139, 92, 246, 0.8), 0 0 20px 4px rgba(139, 92, 246, 0.4), inset 0 0 20px rgba(139, 92, 246, 0.1); 
          }
          50% { 
            box-shadow: 0 0 0 5px rgba(139, 92, 246, 1), 0 0 35px 10px rgba(139, 92, 246, 0.6), inset 0 0 30px rgba(139, 92, 246, 0.2); 
          }
        }
      `}</style>
