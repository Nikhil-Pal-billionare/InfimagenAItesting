          ...
          <div className="border-t border-white/5 pt-2 mt-2">
            ...
            <div className="flex items-center justify-center gap-3 py-2.5">
              <a href="https://x.com/FoxgenContact" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center transition-all" title="X (Twitter)">
              ...
              <a href="https://whatsapp.com/channel/0029VbD5Uoq7T8bS2lLLJr30" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center transition-all" title="WhatsApp">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(255,255,255,0.5)">
              ...
              <a href="https://t.me/Aimges" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center transition-all" title="Telegram">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(255,255,255,0.5)">
